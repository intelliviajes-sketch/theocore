...
export default function TravelerSalesSidebar({
  ...
  return (
    <div className="trav-reveal space-y-4 xl:sticky xl:top-24">
      <section className="trav-panel trav-glass rounded-3xl p-5 transition-all duration-300">
              ...
              return (
                <article key={offer.id} className="trav-hover-card rounded-2xl border border-slate-200 bg-white p-3">
                  ...
                  <button
                    ...
                    className="mt-3 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 px-3 py-1.5 text-[11px] font-semibold text-slate-900 transition-all hover:from-amber-300 hover:to-amber-500 active:scale-[0.98]"
                  >
          ...
          <>
            ...
            {mapUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-3 inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white/90 px-3 py-2 text-xs font-semibold text-slate-700 hover:border-amber-200 hover:bg-white"
              >
      ...
      <section className="trav-panel trav-glass rounded-3xl p-5 transition-all duration-300">
        ...
        <div className="mt-3 grid gap-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white/92 px-3 py-2 text-xs font-semibold text-slate-700 transition-all hover:border-amber-200 hover:bg-white active:scale-[0.98]"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-amber-400 to-amber-500 px-3 py-2 text-xs font-semibold text-slate-900 transition-all hover:from-amber-300 hover:to-amber-500 active:scale-[0.98] disabled:opacity-50"
          >
        ...
        <p className="mt-3 inline-flex items-center gap-2 rounded-xl bg-amber-50 px-3 py-2 text-[11px] font-semibold text-amber-700 ring-1 ring-amber-100">
