                ...
                >
                    ...
                    <div className="relative z-10">
                        ...
                        <h1 className="text-3xl sm:text-4xl font-bold mb-4">
                            Hola <span className="text-yellow-300">{user.name}</span>, ¡bienvenido de nuevo!
                        </h1>
                        <p className="text-lg mb-8 opacity-90">
                            Tu portal de viajes inteligente está listo para ayudarte a planificar aventuras personalizadas, chatear con IA,
                            o descubrir experiencias únicas hechas para ti.
                        </p>
                        <motion.button
                            onClick={onLogout}
